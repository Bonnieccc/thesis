...
class AntSoftActorCritic:
    ...
    def soft_actor_critic(self, env_fn, actor_critic=core.mlp_actor_critic, ac_kwargs=dict(),
        ...
        # Setup model saving
        self.logger.setup_tf_saver(sess, inputs={'x': x_ph, 'a': a_ph}, 
...
if __name__ == '__main__':
    ...
    sac = AntSoftActorCritic(args.env, seed=args.seed, logger_kwargs=logger_kwargs)
    #sac.get_action([0, 0, 0, 0, 0, 0, 0, 0])
    sac.soft_actor_critic(lambda : gym.make(args.env), actor_critic=core.mlp_actor_critic,
